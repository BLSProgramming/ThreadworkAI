...
function ContactUs() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-violet-200 rounded-full mix-blend-multiply filter blur-3xl opacity-25 animate-blob animation-delay-2000"></div>
